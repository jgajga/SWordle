 ...
 * @author 280148
 */
public class WordleWindow extends javax.swing.JDialog {

    WordlePanel wordlePanel;
    /**
     * Creates new form WordleWindow
     */
    public WordleWindow(Setup parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        SWordle sw = parent.sw;
    ...
    public WordleWindow(java.awt.Frame parent, boolean modal) {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                WordleWindow dialog = new WordleWindow(new javax.swing.JFrame(), true);
